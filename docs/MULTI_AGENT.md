...
Il thread principale `jarvis` è l'orchestratore. I sei profili iniziali sono `ge360_sysadmin`, `ge360_docker`, `ge360_developer`, `ge360_crm`, `ge360_automation` e `ge360_wordpress_seo`.
